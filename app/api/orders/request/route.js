  ...
  try {
    ...
    const { error: dbError } = await supabase
      ...
      .insert({
        ...
        connections,
        price,
        status:      "pending",  // pending → invoiced → active
        ...
        html: `
          <div style="font-family:sans-serif;max-width:520px;margin:0 auto;background:#0a0a0f;color:#e8e8f0;padding:2rem;border-radius:12px">
            ...
            <table style="width:100%;border-collapse:collapse">
              ...
              <tr><td style="padding:8px 0;color:#6b7280;font-size:13px">Plan</td>       <td style="padding:8px 0;color:#fff;font-weight:600">${planName} · ${planTerm}</td></tr>
